...
_VERB_ENDINGS_RE = re.compile(
    r'(行|来|出|入|見|言|思|取|持|待|通|違|守|助|探|許|頼|騒|急|知|動|揃|遅|鳴|経|過|儲|隠|殺|払|戻|捨|回|直|替|聞|切|焼|改|造|払|戻|戻|覚|失|逃|去|帰|歩|走|飛|乗|泳|渡|曲|止|始|終|残|進|向|付|着|続|開|閉|治|落|流|組|張|渡|越|減|増|足|引|押|倒|消|壊|割|育|死|当|打|負|勝|戦|闘)$'
)
