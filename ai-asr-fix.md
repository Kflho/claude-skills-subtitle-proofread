...
```bash
python scripts/oped_timecode_detect.py --srt-dir ./日语ai生成字幕/ > oped_blocks.json
```
...
```bash
python scripts/bilingual_detect.py --target-dir ./日语ai生成字幕/ > bilingual.json
```
...
```bash
python scripts/apply_fixes.py --target-dir ./日语ai生成字幕/ --fixes romaji_fixes.json --dry-run
python scripts/apply_fixes.py --target-dir ./日语ai生成字幕/ --fixes romaji_fixes.json
```
...
```bash
python scripts/issue_tracker.py --srt-dir ./日语ai生成字幕/ --video-dir ./videos/ --output-dir ./issues/
```
